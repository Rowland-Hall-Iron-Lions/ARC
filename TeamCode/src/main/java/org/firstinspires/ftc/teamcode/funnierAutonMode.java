...
public class funnierAutonMode extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            frontL.setTargetPosition(100);
            frontR.setTargetPosition(100);
            backL.setTargetPosition(100);
            backR.setTargetPosition(100);
