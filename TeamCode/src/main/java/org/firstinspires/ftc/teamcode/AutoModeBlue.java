...
public class AutoModeBlue extends LinearOpMode {
    ...
    private DcMotor turntableWheel = null;
    ...
    public void runOpMode() {
        ...
        turntableWheel = hardwareMap.get(DcMotor.class, "wheel");
        intakeMotorL = hardwareMap.get(DcMotor.class, "intakeL");
        intakeMotorR = hardwareMap.get(DcMotor.class, "intakeR");
        ...
        while (opModeIsActive()){
            ...
            while (!bc1.isBusy() && !bc2.isBusy() && !bc3.isBusy()){
                ...
                if (distance <= 4){
                    ...
                    intakeMotorL.setPower(5);
                    intakeMotorR.setPower(-5);
